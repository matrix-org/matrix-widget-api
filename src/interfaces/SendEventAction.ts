...
export interface ISendEventFromWidgetResponseData
...
export interface ISendEventFromWidgetActionResponse
  extends ISendEventFromWidgetActionRequest {
  response: ISendEventFromWidgetResponseData;
}

export interface ISendEventToWidgetRequestData
...
export interface ISendEventToWidgetActionResponse
  extends ISendEventToWidgetActionRequest {

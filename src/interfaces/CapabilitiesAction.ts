...
export interface ICapabilitiesActionResponseData
  extends IWidgetApiResponseData {
  capabilities: Capability[];
}

export interface ICapabilitiesActionResponse
  extends ICapabilitiesActionRequest {
  response: ICapabilitiesActionResponseData;
}

export interface INotifyCapabilitiesActionRequestData
...
export interface INotifyCapabilitiesActionResponse
  extends INotifyCapabilitiesActionRequest {
...
export interface IRenegotiateCapabilitiesRequestData
  extends IWidgetApiResponseData {
  capabilities: Capability[];
}

export interface IRenegotiateCapabilitiesActionResponse
  extends IRenegotiateCapabilitiesActionRequest {
  // nothing
}
